...
from feminterface.fem.cards import util_func
...
class GCHANR:
    ...
    def print(self,geono):
        TFEMmod = []
        TFEMmod.append(f'GCHANR    {geono:1.8E}  {self.hz:1.8E}  {self.ty:1.8E}  {self.by:1.8E}\n')
        TFEMmod.append(f'          {self.tz:1.8E}  {self.sfy:1.8E}  {self.sfz:1.8E}  \n')
        TFEMmod.append(f'          {self.k:1.8E}  {self.r:1.8E}  {self.nloby:1.8E}  {self.nlobz:1.8E}  \n')
        return TFEMmod
